/// data : {"lecturer":{"image":"https://api-istchrat.mazadak.net/uploads/lecturers/2022-03-07-07-42-18-06226601a7f77a.png","name":"د. مصطفي أبو سعد","position":"أستشاري نفسي وتربوي ومن رواد العالم العربي","university":"جامعة العلوم والإقتصاد"},"appointment":{"date":"الأحد 27 فبراير","time":"05:30 مساءاُ","period":"30 دقيقة"},"results":{"consultationType":"مكالمة فيديو","consultationFee":"15.00","taxFee":"1.50","totalGrand":"16.50","currency":"دينار"}}

class VideoConfirmAppointmentModel {
  VideoConfirmAppointmentModel({
      Data? data,}){
    _data = data;
}

  VideoConfirmAppointmentModel.fromJson(dynamic json) {
...
/// results : {"consultationType":"مكالمة فيديو","consultationFee":"15.00","taxFee":"1.50","totalGrand":"16.50","currency":"دينار"}
